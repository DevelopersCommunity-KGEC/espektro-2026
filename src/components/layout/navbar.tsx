            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  size="sm"
                  className="hidden md:flex gap-2 items-center h-auto py-2"
                >
                  {activeClubRole ? (
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                  {navItems.map((item) => (
                    <Link
                      ...
                      href={item.href}
                      onClick={() => setIsMobileMenuOpen(false)}
                      className={`text-sm font-medium transition-colors hover:text-primary px-2 py-2 rounded-md hover:bg-muted ${
                        pathname === item.href
                ...
                {hasClubs && (
                  <div className="mt-2 pt-4 border-t">
                    <h4 className="mb-2 px-2 text-sm font-semibold text-muted-foreground uppercase tracking-wider">
                      My Clubs
                    </h4>
                    <div className="flex flex-col gap-1">
                      {clubRoles?.map((cr) => (
                        <Link
                          ...
                          href={`/club/${cr.clubId}/dashboard`}
                          onClick={() => setIsMobileMenuOpen(false)}
                          className={`flex items-center justify-between px-2 py-2 text-sm rounded-md transition-colors hover:bg-muted ${
