...
export const timelineData: TimelineItem[] = [
    {
        ...
        position: { top: '10vh', left: '-9%', width: '35vw', height: 'auto' },
        border: 'right-bottom',
    ...
    },
    {
        ...
        position: { top: '22vh', left: '3%', width: '35vw', height: 'auto' },
        border: 'left-bottom',
    ...
    },
    {
        ...
        position: { top: '10vh', left: '13%', width: '33vw', height: 'auto' },
        border: 'right-top',
    ...
    },
    {
        ...
        position: { top: '-3vh', left: '24%', width: '40vw', height: 'auto' },
        border: 'left-top',
    ...
    },
    {
        ...
        position: { top: '4vh', left: '37%', width: '45vw', height: 'auto' },
        border: 'right-bottom',
    ...
    },
    {
        ...
        position: { top: '20vh', left: '52%', width: '35vw', height: 'auto' },
        border: 'left-top',
    ...
    },
    {
        ...
        position: { top: '26vh', left: '63%', width: '35vw', height: 'auto' },
        border: 'left-top',
    ...
    },
    {
        ...
        position: { top: '19vh', left: '75%', width: '35vw', height: 'auto' },
        border: 'left-top',
